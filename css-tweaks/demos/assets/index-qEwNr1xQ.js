const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./fabric-DqEtiN5b.js","./main-CHt_w1XH.js","./preload-helper-dJJaZANz.js","./main-TP8YGD_o.css","./index-J5-_rbll.js","./index-BxXa10wp.js","./index-CQA9_06N.js","./index-zur4GECx.js","./index-_057B9jY.js","./index-bUFgnult.js","./index-CEh0Upr9.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from './preload-helper-dJJaZANz.js';
import { iS as commonjsGlobal, iT as getDefaultExportFromCjs, bA as FixtureInstance, fF as useExportStore, he as markRaw, fO as GlobalEvents, hf as useAppbarStore } from './main-CHt_w1XH.js';
import { _ as _sfc_main } from './screen.vue_vue_type_script_setup_true_lang-C0f71GZQ.js';
...
class ExportAPI extends FixtureInstance {
  ...
  async make(canvas, panelWidth) {
    const { fabric } = await __vitePreload(async () => { const { fabric } = await import('./fabric-DqEtiN5b.js').then(n => n.f);return { fabric }},true?__vite__mapDeps([0,1,2,3]):void 0,import.meta.url);
...
class ExportFixture extends ExportAPI {
  ...
  async needed() {
    const exportTitle = (await __vitePreload(async () => { const {default: __vite_default__} = await import('./index-J5-_rbll.js');return { default: __vite_default__ }},true?__vite__mapDeps([4,0,1,2,3]):void 0,import.meta.url)).default;
    const exportMap = (await __vitePreload(async () => { const {default: __vite_default__} = await import('./index-BxXa10wp.js');return { default: __vite_default__ }},true?__vite__mapDeps([5,0,1,2,3]):void 0,import.meta.url)).default;
    const exportLegend = (await __vitePreload(async () => { const {default: __vite_default__} = await import('./index-CQA9_06N.js');return { default: __vite_default__ }},true?__vite__mapDeps([6,1,2,3,0]):void 0,import.meta.url)).default;
    const exportNorthArrow = (await __vitePreload(async () => { const {default: __vite_default__} = await import('./index-zur4GECx.js');return { default: __vite_default__ }},true?__vite__mapDeps([7,0,1,2,3]):void 0,import.meta.url)).default;
    const exportScalebar = (await __vitePreload(async () => { const {default: __vite_default__} = await import('./index-_057B9jY.js');return { default: __vite_default__ }},true?__vite__mapDeps([8,0,1,2,3]):void 0,import.meta.url)).default;
    const exportTimestamp = (await __vitePreload(async () => { const {default: __vite_default__} = await import('./index-bUFgnult.js');return { default: __vite_default__ }},true?__vite__mapDeps([9,0,1,2,3]):void 0,import.meta.url)).default;
    const exportFootnote = (await __vitePreload(async () => { const {default: __vite_default__} = await import('./index-CEh0Upr9.js');return { default: __vite_default__ }},true?__vite__mapDeps([10,0,1,2,3]):void 0,import.meta.url)).default;
