import { af as le, hX as ue } from "./main-DNcervVH.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-C4e0GERJ.js").then((i) => i.l) : await import("./libtess-BBwc9DRH.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-C_qWfa7X.js.map
