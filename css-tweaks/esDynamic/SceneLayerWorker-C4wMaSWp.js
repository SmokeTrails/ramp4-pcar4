import { hX as K, bh as D } from "./main-DNcervVH.js";
import { y as X } from "./DoubleArray-Dce73sOF.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-BgBSGj8y.js";
import { n as Z, s as ee } from "./vec3-DGNhGlgt.js";
import "./sphere-Dsj1QR0n.js";
import "./I3SUtil-BGtYQ3hv.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-DvOKkgJS.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-DNcervVH.js").then((d) => d.qK), import("./main-DNcervVH.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-CB2w6aQ6.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-C4wMaSWp.js.map
