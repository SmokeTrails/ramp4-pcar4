const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./fabric-XIaDKpU_.js","./main-Bzk8b5UZ.js","./preload-helper-dJJaZANz.js","./main-CY4W0263.css","./index-Clltgn-s.js","./index-BOh2JfIc.js","./index-8-OX9pR4.js","./index-5fajwZFY.js","./index-DdmUC8vy.js","./index-9OGr2lCj.js","./index-DMNlzwPy.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from './preload-helper-dJJaZANz.js';
import { iS as commonjsGlobal, iT as getDefaultExportFromCjs, bA as FixtureInstance, fF as useExportStore, he as markRaw, fO as GlobalEvents, hf as useAppbarStore } from './main-Bzk8b5UZ.js';
import { _ as _sfc_main } from './screen.vue_vue_type_script_setup_true_lang-BYNZRpS4.js';
...
class ExportAPI extends FixtureInstance {
  ...
  async make(canvas, panelWidth) {
    const { fabric } = await __vitePreload(async () => { const { fabric } = await import('./fabric-XIaDKpU_.js').then(n => n.f);return { fabric }},true?__vite__mapDeps([0,1,2,3]):void 0,import.meta.url);
...
class ExportFixture extends ExportAPI {
  ...
  async needed() {
    const exportTitle = (await __vitePreload(async () => { const {default: __vite_default__} = await import('./index-Clltgn-s.js');return { default: __vite_default__ }},true?__vite__mapDeps([4,0,1,2,3]):void 0,import.meta.url)).default;
    const exportMap = (await __vitePreload(async () => { const {default: __vite_default__} = await import('./index-BOh2JfIc.js');return { default: __vite_default__ }},true?__vite__mapDeps([5,0,1,2,3]):void 0,import.meta.url)).default;
    const exportLegend = (await __vitePreload(async () => { const {default: __vite_default__} = await import('./index-8-OX9pR4.js');return { default: __vite_default__ }},true?__vite__mapDeps([6,1,2,3,0]):void 0,import.meta.url)).default;
    const exportNorthArrow = (await __vitePreload(async () => { const {default: __vite_default__} = await import('./index-5fajwZFY.js');return { default: __vite_default__ }},true?__vite__mapDeps([7,0,1,2,3]):void 0,import.meta.url)).default;
    const exportScalebar = (await __vitePreload(async () => { const {default: __vite_default__} = await import('./index-DdmUC8vy.js');return { default: __vite_default__ }},true?__vite__mapDeps([8,0,1,2,3]):void 0,import.meta.url)).default;
    const exportTimestamp = (await __vitePreload(async () => { const {default: __vite_default__} = await import('./index-9OGr2lCj.js');return { default: __vite_default__ }},true?__vite__mapDeps([9,0,1,2,3]):void 0,import.meta.url)).default;
    const exportFootnote = (await __vitePreload(async () => { const {default: __vite_default__} = await import('./index-DMNlzwPy.js');return { default: __vite_default__ }},true?__vite__mapDeps([10,0,1,2,3]):void 0,import.meta.url)).default;
