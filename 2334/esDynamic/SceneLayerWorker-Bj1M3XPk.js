import { hX as K, bh as D } from "./main-Bh1f0za8.js";
import { y as X } from "./DoubleArray-DJpu_HJ2.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-CFpC0YH2.js";
import { n as Z, s as ee } from "./vec3-BOKcSXEz.js";
import "./sphere-CuaZfM7T.js";
import "./I3SUtil-TRZQZ-2Y.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-B1FpOt81.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-Bh1f0za8.js").then((d) => d.qK), import("./main-Bh1f0za8.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-DKa5cwcQ.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-Bj1M3XPk.js.map
