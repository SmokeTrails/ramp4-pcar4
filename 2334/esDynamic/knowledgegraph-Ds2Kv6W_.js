import { Q as x, a4 as Q, b7 as E, b8 as A, b9 as K, bh as I, a0 as M, eJ as W, eN as U, eO as j } from "./main-Bh1f0za8.js";
import { a as k, b as u, r as f, x as B, d as G, G as w, a9 as C, v as V, N as T, U as b, q as O, E as P, X as q, k as X, t as Y, aa as z, ab as D, ac as H } from "./arcadeUtils-DsWToQRE.js";
import { l as L } from "./portalUtils-DPIkawem.js";
import { p as Z, n as _ } from "./project-B2mDgk2z.js";
import { a as $, m as nn, t as tn, p as en, c as an } from "./GraphQueryStreaming--X3c88cD.js";
let c = null;
async function rn(n) {
...
async function N(n, t) {
  ...
  return await a.load(), c === null && (c = await import("./knowledgeGraphService-CjqpkDa4.js").then((i) => i.k)), await c.fetchKnowledgeGraph(a.url);
}
...
function pn(n) {
  n.mode === "async" && (n.functions.knowledgegraphbyportalitem = function(t, a) {
    ...
    return n.standardFunctionAsync(t, a, async (i, s, e) => {
      ...
      c === null && (c = await import("./knowledgeGraphService-CjqpkDa4.js").then((o) => o.k));
      let p = null;
      const m = V(e[2], null);
...
//# sourceMappingURL=knowledgegraph-Ds2Kv6W_.js.map
