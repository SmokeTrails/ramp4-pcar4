import { hX as T } from "./main-Bh1f0za8.js";
...
function y() {
  return new Promise((t) => import("./lyr3DWorker-Z-IE_p0p.js").then((r) => r.l).then(({ default: r }) => {
...
//# sourceMappingURL=Lyr3DWorker-lehTSnlW.js.map
