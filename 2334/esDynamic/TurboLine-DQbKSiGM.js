import { af as le, hX as ue } from "./main-Bh1f0za8.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-BlX2l9Op.js").then((i) => i.l) : await import("./libtess-hJg7quZy.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-DQbKSiGM.js.map
